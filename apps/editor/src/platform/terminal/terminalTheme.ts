...
const terminalThemes: Record<BuiltInThemeId, ITheme> = {
  ...
  "axon-parchment": {
    ...
    foreground: "#282828ff",
    cursor: "#0b6678ff",
    cursorAccent: "#f2e5bcff",
    selectionBackground: "#0b66783d",
    black: "#282828ff",
    brightBlack: "#73675eff",
    red: "#9d0308ff",
    brightRed: "#db8b7aff",
    green: "#797410ff",
    brightGreen: "#bfb787ff",
    yellow: "#b57615ff",
    brightYellow: "#e2b88bff",
    blue: "#0b6678ff",
    brightBlue: "#8fb0baff",
    magenta: "#8f3e71ff",
    brightMagenta: "#c76da0ff",
    cyan: "#437b59ff",
    brightCyan: "#9fbca8ff",
    white: "#f2e5bcff",
    brightWhite: "#f2e5bcff",
  },
  sora: {
    background: "#10131a",
    foreground: "#d4dae7",
