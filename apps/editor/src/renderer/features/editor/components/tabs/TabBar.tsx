...
function ContextMenu({
  ...
  return createPortal(
    <div
      className="axon-popup-surface fixed z-[200] min-w-48 overflow-hidden rounded-md border border-[var(--axon-panel-border)] bg-[var(--axon-panel-background)] py-1 text-[var(--axon-editor-foreground)] shadow-[0_18px_48px_rgba(0,0,0,0.38)] ring-1 ring-white/[0.03]"
      style={{
