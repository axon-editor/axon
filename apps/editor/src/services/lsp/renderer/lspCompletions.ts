...
import {
  ...
  localSymbolLanguages,
  lspCompletionLanguages,
  packageExportCompletionLanguages,
  pythonBuiltinSuggestions,
  tailwindUtilityLanguages,
  tailwindUtilitySuggestions,
  tailwindVariantPrefixes,
  webTagLanguages,
  webTagSnippets,
} from "./lspCompletionData";
