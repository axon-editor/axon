...
export function createSyntaxRules(tokens: ThemeTokenMap): editor.ITokenThemeRule[] {
  ...
  return [
    ...
    { token: "type.ts", foreground: type },
    { token: "type.typescript", foreground: type },
    ...
    { token: "identifier.function", foreground: fn },
    { token: "identifier.function.ts", foreground: fn },
    { token: "identifier.function.typescript", foreground: fn },
    { token: "entity.name.function", foreground: fn },
    { token: "support.function.go", foreground: fn },
    { token: "identifier.function.go", foreground: fn },
    { token: "identifier.function.rust", foreground: fn },
    { token: "identifier.function.python", foreground: fn },
    { token: "support.function", foreground: fn, fontStyle: "italic" },
    { token: "method", foreground: method },
    { token: "method.call", foreground: method },
    { token: "identifier.method", foreground: method },
    { token: "identifier.method.ts", foreground: method },
    { token: "identifier.method.typescript", foreground: method },
    { token: "member", foreground: method },
    { token: "member.go", foreground: method },
    { token: "member.rust", foreground: method },
    { token: "variable", foreground: variable },
    { token: "identifier", foreground: variable },
    { token: "identifier.ts", foreground: variable },
    { token: "identifier.typescript", foreground: variable },
    { token: "identifier.jsx", foreground: variable },
    { token: "identifier.tsx", foreground: variable },
    { token: "identifier.go", foreground: variable },
    { token: "identifier.rust", foreground: variable },
    { token: "identifier.python", foreground: variable },
    { token: "variable.parameter", foreground: parameter },
    { token: "parameter", foreground: parameter },
    { token: "identifier.parameter", foreground: parameter },
    { token: "property", foreground: property },
    { token: "identifier.property", foreground: property },
    { token: "identifier.property.ts", foreground: property },
    { token: "identifier.property.typescript", foreground: property },
    ...
    { token: "tag.tsx", foreground: tag },
    { token: "tag.jsx", foreground: tag },
    { token: "entity.name.tag", foreground: tag },
    { token: "attribute.name", foreground: attribute },
    { token: "attribute.name.tsx", foreground: attribute },
    { token: "attribute.name.jsx", foreground: attribute },
    ...
    { token: "key.json", foreground: property },
    { token: "key.yaml", foreground: property },
    { token: "keyword.dockerfile", foreground: keyword, fontStyle: "italic" },
    { token: "variable.dockerfile", foreground: variable },
