...
export default function TestExplorerModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/45">
      <div className="absolute bottom-8 left-1/2 top-20 flex w-[min(860px,calc(100vw-2rem))] -translate-x-1/2 flex-col overflow-hidden rounded-lg border border-[var(--axon-panel-border)] bg-[var(--axon-panel-background)] shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
