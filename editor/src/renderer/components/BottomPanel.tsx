...
export default function BottomPanel({
  ...
  return (
    <div className="h-56 shrink-0 border-t border-[#202533] bg-[#0a0c12] text-[#9aa4b8]">
      ...
      {activeTab === "problems" && (
        <div className="flex h-[calc(100%-36px)] items-center justify-center px-4 text-center text-[12px] text-[#586478]">
          No problems in this workspace yet.
        </div>
      )}

      {activeTab === "output" && (
        <div className="h-[calc(100%-36px)] overflow-y-auto px-4 py-3 font-mono text-[11px] leading-5 text-[#647086]">
